            ...
            <section id="testimonials" className="py-24 md:py-32">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="mt-4 text-xl text-muted-foreground">{locale === 'fr' ? 'Chargement des témoignages...' : 'Loading testimonials...'}</p>
                    </motion.div>
        ...
        return (
            <section id="testimonials" className="py-24 md:py-32">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    >
                        <h2 className="text-4xl font-bold tracking-tight">{t("title")}</h2>
                        <p className="mt-4 text-xl text-muted-foreground">{locale === 'fr' ? 'Aucun témoignage disponible pour le moment.' : 'No testimonials available at this time.'}</p>
                    </motion.div>
                </div>
            </section>
        );
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                    ...
                    <p className="mt-4 text-xl text-muted-foreground">
                        {locale === 'fr' ? 'Ce que les clients disent de mon travail' : 'What clients say about working with me'}
                    </p>
                </motion.div>
